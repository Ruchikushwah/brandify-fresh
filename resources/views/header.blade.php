                    ...
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-4">
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute hidden group-hover:block bg-white text-gray-800 rounded-md shadow-lg mt-1 w-40 ">
                                    <a href="{{route('intropage')}}" class="block px-5 py-2 text-sm hover:bg-gray-100 border-b">intro</a>
                                    <a href="{{route('founders')}}" class="block px-5 py-2 text-sm hover:bg-gray-100 border-b">our Founders</a>
                                    <a href="{{route('advisory-board')}}" class="block px-5 py-2 text-sm hover:bg-gray-100 border-b">Advisory board</a>
                                </div>
                            </div>
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute hidden group-hover:block bg-white text-gray-800 rounded-md shadow-lg mt-1 w-36 ">
                                    <a href="{{route('network-distribution')}}" class="block px-4 py-2 text-sm hover:bg-gray-300 border-b">Distribution</a>
                                    <a href="{{route('case-study')}}" class="block px-4 py-2 text-sm hover:bg-gray-300">case study</a>
                                </div>
                            </div>
