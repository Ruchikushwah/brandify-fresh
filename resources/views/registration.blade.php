...
<div class=" h-[500px] w-full bg-blue-300 ">

    <div class=" grid grid-cols-3 m-10 justify-center gap-2  p-28">
        <div class=" h-[250px]  w-[250px] border border-slate-600 rounded-2xl">
